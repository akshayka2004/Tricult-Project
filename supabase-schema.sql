...
-- 3. Sessions table (for volunteer hub monitoring)
...
-- 6. Seed admin user (password: admin123 — bcrypt hash)
INSERT INTO profiles (ticket_number, username, password, is_admin, balance_tokens)
VALUES (
  'ADMIN-001',
  'Event Admin',
  '$2b$10$ie7/0iEEJXV7TL303nowVeLZEGAsmnOid6sTrQ9BmCb.sZHbRQj36',
  true,
  0
);

-- 7. Seed volunteer user (password: volunteer123 — bcrypt hash)
INSERT INTO profiles (ticket_number, username, password, is_volunteer, balance_tokens)
VALUES (
  'VOL-001',
  'Hub Volunteer',
  '$2b$10$RtTDo4bwZCyR.jq/BcDBkOVlOl8KbFcgBpm183nB.mqtS3k72ZaD2',
  true,
  0
);
